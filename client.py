...
class Send(threading.Thread):
    ...
    def run(self):
        # listen for user input from command line and send to
    ...
    def run(self):
        ...
        while True:
            ...
            if message:
                ...
                print('\n Not possible, we have lost connection to the server!')
                print('\n Quitting...')
                self.sock.close()
                os.exit(0)
...
class Client:
    ...
    def start (self):
        ...
        # Create a send and receive thread
